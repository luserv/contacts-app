...
import { ContactEmail, ContactKeyword, ContactOrganization, ContactPhone, IdentityCard, Relationship, useContacts } from '../../utils/context';
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <OrganizationsCard contactId={id} initialOrganizations={organizations} />
